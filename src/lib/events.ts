...
function sampleNight(window: NightWindow): Date[] {
 ...
 *
 * Na razie Księżyc i roje meteorów. Koniunkcje, opozycje i zaćmienia dojdą razem
 * z Astronomy Engine — kategoria „Planety" do tego czasu bywa pusta.
 */
export function upcomingEvents(
  ...
  return [...moonPhaseEvents(from, to, coords), ...meteorShowerEvents(from, to, coords)].sort(
